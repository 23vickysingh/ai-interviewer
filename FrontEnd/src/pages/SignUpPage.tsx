  ...
  return (
    <div className="min-h-screen bg-hero flex items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground text-center mb-6">Start practicing interviews for free</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Alex Chen" className="pl-9" />
            </div>
          </div>
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="alex@example.com" className="pl-9" />
            </div>
          </div>
          <div>
